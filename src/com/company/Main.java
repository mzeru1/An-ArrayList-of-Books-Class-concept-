//Our book application contains two files, or classes.
// The first contains the main method which allows
// the user to create a book and add it to an arrayList.
// Then the list is printed.
//
package com.company;

//import java.awt.print.Book;    // we don't import the class Book because its in the same package
